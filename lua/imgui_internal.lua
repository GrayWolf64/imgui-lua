...
--- @nodiscard
function ImRect(a, b, c, d)
    local ret_no_tcall
    if c and d then
        ret_no_tcall = setmetatable({ ImVec2(a, b), ImVec2(c, d) }, IM_RECT)
    else
        ret_no_tcall = setmetatable({ ImVec2(a and a.x or 0, a and a.y or 0), ImVec2(b and b.x or 0, b and b.y or 0) }, IM_RECT)
    end
    return ret_no_tcall
end
