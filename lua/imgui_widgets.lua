...
local function CollapseButton(id, pos)
    ...
    if window.Collapsed then
        RenderArrow(window.DrawList, bb.Min, g.Style.Colors.Text, Enums.ImGuiDir.Right, 1)
    else
        RenderArrow(window.DrawList, bb.Min, g.Style.Colors.Text, Enums.ImGuiDir.Down, 1)
    end
